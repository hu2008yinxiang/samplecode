...
function showNews($news, $app)
{
    ...
    <?php
		...
		class="highlight"><?php echo $news->title;?></span>, you can get <span
		class="highlight"><?php echo intval(max(explode(',',$news->content)) * 100 - 100), '%';?> extra</span> for the purchasing! Please check the details in store.
	</li>
                                                    <?php
            break;
        case News::TYPE_SPECIAL_OFFER:
            ?>
                                                                <li
		class="STYLE3p">From <?php echo $startDate->format('m/d');?> to <?php echo $endDate->format('m/d');?>, <span
		class="highlight">special offer</span> send out every day.
	</li>
                                                                <?php
            break;
        default:
...
<img id="banner" alt="Banner" src="images/banner.jpg">
	<div style="padding-left: 6px; padding-right: 6px;">
		<div class="STYLE5">
			...
			<div>
				<p class="STYLE3p">The following events is on going:</p>
			</div>
		</div>
		<div>
			<ol>
